...
const Dashboard = ({ navigation }) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setNutritionData([
                    ...
                    {
                        title: "Protein",
                        goal: nutritionsData?.protein || 0,
                        current: totalProtein,
                        remaining:
                            (nutritionsData?.protein || 0) - totalProtein,
                    },
                    {
                        title: "Carbs",
                        goal: nutritionsData?.carbs || 0,
                        current: totalCarbs,
                        remaining: (nutritionsData?.carbs || 0) - totalCarbs,
                    },
                    {
                        title: "Fat",
                        goal: nutritionsData?.fat || 0,
                        current: totalFat,
                        remaining: (nutritionsData?.fat || 0) - totalFat,
                    },
                ]);
            }
        } catch (error) {
    ...
    return (
        <View style={{ flex: 1, marginTop: 45, margin: 20 }}>
                ...
                <View>
                    <View style={styles.infoBoxRow}>
                        ...
                        <Text style={styles.valueText}>
                            {user.details?.weight || "N/A"} kg
                        </Text>
                    </View>
                </View>

                <TouchableOpacity
                    onPress={() => navigation.navigate("DashboardEdit")}
                >
                    <View>
